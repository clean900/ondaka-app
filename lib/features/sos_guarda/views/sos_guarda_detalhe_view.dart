...
class SosGuardaDetalheView extends StatefulWidget {
  final int alertaId;
  const SosGuardaDetalheView({super.key, required this.alertaId});

  @override
  State<SosGuardaDetalheView> createState() => _SosGuardaDetalheViewState();
}

class _SosGuardaDetalheViewState extends State<SosGuardaDetalheView> {
